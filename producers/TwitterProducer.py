...
class TwitterProducer:
    def __init__(self, server, username, password, email, mail_pass=None):
        ...
        self.username = '@Zziineebb'
        self.password = 'Bigproject@ensa'
        self.email = 'aallaouizineb73@gmail.com'
        self.mail_pass = 'None'
...
if __name__ == "__main__":
    ...
    username = "@Zziineebb"  # replace with your Twitter username
    password = "F145025837@ensa"  # replace with your Twitter password
    email = "aallaouizineb73@gmail.com"  # replace with your email
    mail_pass = "None"  # replace with your email password (optional)
